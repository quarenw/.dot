...
call s:Color('dark0_hard',  ['#1d2021', 234])     " 29-32-33 NOTHING
call s:Color('dark0',       ['#2d333b', 235])     " 40-40-40 BACKGROUND
call s:Color('dark0_soft',  ['#32302f', 236])     " 50-48-47 NOTHING
call s:Color('dark1',       ['#3c3836', 237])     " 60-56-54 NOTHING
call s:Color('dark2',       ['#504945', 239])     " 80-73-69 NOTHING
call s:Color('dark3',       ['#665c54', 241])     " 102-92-84 NOTHING
call s:Color('dark4',       ['#adbac7', 243])     " 124-111-100 GUTTER
call s:Color('dark4_256',   ['#768390', 243])     " 124-111-100 NOTHING 

call s:Color('gray_245',    ['#928374', 245])     " 146-131-116 COMMENTS
call s:Color('gray_244',    ['#928374', 244])     " 146-131-116 NOTHING

call s:Color('light0_hard', ['#f9f5d7', 248])     " 249-245-215 NOTHING
call s:Color('light0',      ['#adbac7', 248])     " 253-244-193 NOTHING
call s:Color('light0_soft', ['#f2e5bc', 248])     " 242-229-188 NOTHING
call s:Color('light1',      ['#ebdbb2', 251])     " 235-219-178 TEXT :: LINE
call s:Color('light2',      ['#d5c4a1', 248])     " 213-196-161 NOTHING
call s:Color('light3',      ['#bdae93', 248])     " 189-174-147 NOTHING
call s:Color('light4',      ['#ADBAC7', 248])     " 168-153-132 NOTHING
call s:Color('light4_256',  ['#ADBAC7', 248])     " 168-153-132 NOTHING

call s:Color('bright_red',     ['#ff938a', 203])     " 251-73-52 IF WHILE
call s:Color('bright_green',   ['#8ddb8c', 117])     " 184-187-38 STRING + FUNCTION
call s:Color('bright_yellow',  ['#eac55f', 215])     " 250-189-47  :: PARAMS
call s:Color('bright_blue',    ['#96d0ff', 215])     " 131-165-152  ///
call s:Color('bright_purple',  ['#dcbdfb', 183])     " 211-134-155 // std:: 
call s:Color('bright_aqua',    ['#F79981', 210])     " 142-192-124 // INCLUDE
call s:Color('bright_orange',  ['#f69d50', 75])     " 254-128-25 // THIS

call s:Color('neutral_red',    ['#f47067', 203])     " 204-36-29
call s:Color('neutral_green',  ['#6bc46d', 77])     " 152-151-26
call s:Color('neutral_yellow', ['#daaa3f', 179])     " 215-153-33
call s:Color('neutral_blue',   ['#6cb6ff', 75])      " 69-133-136
call s:Color('neutral_purple', ['#b083f0', 141])     " 177-98-134
call s:Color('neutral_aqua',   ['#EC775C', 209])      " 104-157-106
call s:Color('neutral_orange', ['#e0823d', 173])     " 214-93-14

call s:Color('faded_red',      ['#e5534b', 167])      " 157-0-6
call s:Color('faded_green',    ['#57ab5a', 71])     " 121-116-14
call s:Color('faded_yellow',   ['#c69026', 172])     " 181-118-20
call s:Color('faded_blue',     ['#316dca', 62])      " 7-102-120
call s:Color('faded_purple',   ['#986ee2', 98])      " 143-63-113
call s:Color('faded_aqua',     ['#DE5B41', 167])      " 66-123-88
call s:Color('faded_orange',   ['#cc6b2c', 166])     " 175-58-3
